use {
    ...
    gtk4::{
        glib::MainContext,
        prelude::{BoxExt, ButtonExt, CheckButtonExt, DialogExt, GtkWindowExt, WidgetExt},
...
impl AccessUi {
    ...
    fn run_impl(
        ...
        if let Some(icon) = &self.icon {
            ...
            // In GTK4 MessageDialog doesn't have set_image anymore. We can just add it to area.
            // But usually it goes above. We'll just put it in the message area if icon is provided.
            area.prepend(&image);
        }
