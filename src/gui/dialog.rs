...
impl CustomDialog {
    pub fn new(title: &str, modal: bool) -> Self {
        ...
        let content_area = Box::new(gtk4::Orientation::Vertical, 6);
        ...
        let action_area = Box::new(gtk4::Orientation::Horizontal, 6);
        action_area.set_halign(Align::End);
